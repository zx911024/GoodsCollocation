...
class collocation():
    ...
    def cat_id(self,item_id):
        '''
        查找商品类别ID
        :param item_id:
        :return:
        '''
        # return item's cat_id
        i=0
        dim_items = open('./data/small_dim_items.txt', 'r')
    ...
    def item_cat(self):# build fashion_cat.txt
        ...
        i = 0
        fashion_cat = []
        fashion_cat_file = open('./data/fashion_cat.txt', 'a')
    ...
    def all_cat_mat_frequency(self ,item1):
        ...
        dict_cat_match_num ={}
        dict_item_match = {}
        fashion_cat = open('./data/fashion_cat.txt', 'r')
